...
{
    public class BaseFeatureFactory<TAchievement, TAchievementManager, TActionFactory, TActionType, TActiveAction, TDataContext, TEntityMapper, TFeature, TFeatureFactory, TFeatureParameters, TFeatureType, TFight, TFighterState, TFighterStats, TFightingGame, TModifier, TModifierParameters, TModifierType, TUser>
...

    {
        ...
        public TFeature Build(TFeatureType featureType, TUser receiver)
        {
            var feature = (TFeature)Activator.CreateInstance(featureType.MatchingType);
            feature.Activate(receiver);
            return feature;
        }
    }
}