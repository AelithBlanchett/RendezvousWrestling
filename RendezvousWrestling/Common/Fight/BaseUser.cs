...
public abstract class BaseUser<TAchievement, TActionFactory, TActiveAction, TEntityMapper, TFeature, TFeatureFactory, TFeatureParameters, TFeatureType, TFight, TFighterState, TFighterStats, TFightingGame, TModifier, TModifierParameters, TModifierType, TUser> : BaseEntity
    ...
    where TUser : BaseUser<TAchievement, TActionFactory, TActiveAction, TEntityMapper, TFeature, TFeatureFactory, TFeatureParameters, TFeatureType, TFight, TFighterState, TFighterStats, TFightingGame, TModifier, TModifierParameters, TModifierType, TUser>, new()
{
    ...
    public int addFeature(TFeatureType type, int matches)
    {
        ...
        if (feature == null)
        {
            throw new Exception($"Feature not found. These are the existing features: {string.Join(",", new TFeatureType().FeaturesList)}");
        }
